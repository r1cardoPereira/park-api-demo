...
public class UsuarioController {
     ...
     * @param usuarioSenhaDto O DTO com a senha atual, a nova senha e a confirmação da nova senha.
    ...
    public ResponseEntity<Void> updatePassword(@PathVariable Long id, @Valid @RequestBody UsuarioSenhaDto usuarioSenhaDto){
        ...
        Usuario user;
        user = usuarioService.changePassword(id, usuarioSenhaDto.getSenhaAtual(), usuarioSenhaDto.getNovaSenha(), usuarioSenhaDto.getConfirmaNovaSenha());
